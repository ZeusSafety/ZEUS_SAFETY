  ...
  return (
    <div className="relative" ref={selectRef}>
      <button
        ...
        disabled={disabled}
        className={`w-full px-4 py-2.5 border rounded-lg transition-all duration-200 text-sm flex items-center justify-between ${disabled
            ? 'border-gray-300 bg-gray-100 text-gray-600 cursor-not-allowed'
            : `border-gray-200 bg-[#F7FAFF] text-gray-900 shadow-sm hover:shadow-md focus:ring-2 focus:ring-blue-700 focus:border-blue-700 focus:bg-white ${isOpen ? 'ring-2 ring-blue-700 border-blue-700 bg-white' : ''
            }`
          }`}
