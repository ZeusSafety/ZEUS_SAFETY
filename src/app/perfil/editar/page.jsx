              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex justify-end space-x-3 pt-4 border-t border-gray-200">
                  ...
                  <button
                    type="submit"
                    disabled={isLoading}
                    className="px-6 py-2.5 bg-gradient-to-br from-[#155EEF] to-[#1D4ED8] text-white rounded-lg font-semibold shadow-sm hover:shadow-md hover:scale-105 transition-all duration-200 active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed text-sm"
                  >
