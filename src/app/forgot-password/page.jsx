...
export default function ForgotPasswordPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4" style={{ background: '#F7FAFF' }}>
      ...
      <div className="w-full flex items-center justify-center animate-fadeIn">
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="bg-white rounded-3xl border border-gray-200/80 overflow-hidden" style={{ borderRadius: '14px', boxShadow: '0px 4px 12px rgba(0,0,0,0.06)' }}>
            {/* Barra superior */}
            <div className="h-2 bg-gradient-to-r from-[#1E63F7] to-[#3A8DFF]"></div>
            ...
            <div className="p-6 sm:p-7">
              ...
              <div className="text-center mb-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="w-16 h-1 bg-gradient-to-r from-[#1E63F7] to-[#3A8DFF] mx-auto rounded-full"></div>
              ...
              {!isSuccess ? (
                <form className="space-y-5" onSubmit={handleSubmit}>
                  ...
                  <div className="pt-2 flex justify-center">
                    <button
                      type="submit"
                      className="w-2/3 max-w-xs bg-gradient-to-br from-[#1E63F7] to-[#1E63F7] text-white font-semibold py-3 px-6 rounded-xl flex items-center justify-center space-x-2 shadow-sm hover:shadow-md hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-[#1E63F7] focus:ring-offset-2 transition-all duration-200 active:scale-[0.98] relative overflow-hidden text-sm group"
                      disabled={isLoading}
                    >
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-gradient-to-br from-blue-50 to-slate-50 border-2 border-blue-200 rounded-xl p-5 text-center">
                    <div className="flex justify-center mb-3">
                      <div className="w-14 h-14 bg-[#1E63F7]/20 backdrop-blur-sm rounded-full flex items-center justify-center border-2 border-[#0B327B]">
                  ...
                  <div className="pt-2 flex justify-center">
                    <Link
                      href="/login"
                      className="w-2/3 max-w-xs bg-gradient-to-br from-[#1E63F7] to-[#1E63F7] text-white font-semibold py-3 px-6 rounded-xl flex items-center justify-center space-x-2 shadow-sm hover:shadow-md hover:scale-105 transition-all duration-200 active:scale-[0.98] text-sm group"
                    >
                      <span className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 transform -skew-x-12 group-hover:animate-shimmer"></span>
                      <span className="relative z-10 flex items-center space-x-2">
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
