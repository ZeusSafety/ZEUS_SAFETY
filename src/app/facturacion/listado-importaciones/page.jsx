                        ...
                        <tr>
                          <td colSpan={10} className="px-3 py-8 text-center">
                            <div className="flex items-center justify-center space-x-2">
                              <div className="animate-spin rounded-full h-5 w-5 border-b-2 border-[#002D5A]"></div>
                          ...
                          <td colSpan={10} className="px-3 py-8 text-center">
                            <div className="flex flex-col items-center justify-center space-y-2">
                              ...
                              <button
                                ...
                                className="mt-2 px-4 py-2 bg-gradient-to-br from-[#002D5A] to-[#002D5A] text-white rounded-lg text-xs font-semibold hover:opacity-90 transition-all duration-200 shadow-sm hover:shadow-md"
                              >
                                Reintentar
                              </button>
                            </div>
                          ...
                          <tr key={facturacion.id} className="hover:bg-slate-200 transition-colors" onClick={(e) => {
                            ...
                            <td className="px-3 py-2 whitespace-nowrap">
                              <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-semibold border-2 ${facturacion.incidencias
                                ...
                                : "bg-[#48A98E] border-[#48A98E] text-white"
                                }`}>
                            ...
                            <td className="px-3 py-2 whitespace-nowrap">
                              <button
                                ...
                                className="flex items-center justify-center w-8 h-8 bg-[#002D5A] text-white rounded-full text-[10px] font-semibold hover:opacity-90 transition-all duration-200 shadow-sm hover:shadow-md active:scale-[0.95]"
                              >
                            ...
                            <td className="px-3 py-2 whitespace-nowrap">
                              <button
                                ...
                                className="flex items-center space-x-1 px-3 py-1.5 bg-gradient-to-br from-[#002D5A] to-[#002D5A] text-white rounded-lg text-[10px] font-semibold hover:opacity-90 transition-all duration-200 shadow-sm hover:shadow-md active:scale-[0.95]"
                              >
