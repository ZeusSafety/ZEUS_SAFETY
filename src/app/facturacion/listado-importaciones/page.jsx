                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="bg-blue-700/20 backdrop-blur-md border-b border-blue-700/40">
                        ...
                        <th className="px-3 py-2 text-left text-[10px] font-bold uppercase tracking-wider text-blue-800 whitespace-nowrap">SOLUCIÓN PDF</th>
                        <th className="px-3 py-2 text-left text-[10px] font-bold uppercase tracking-wider text-blue-800 whitespace-nowrap">FECHA DE INCIDENCIAS</th>
                        ...
                        <th className="px-3 py-2 text-left text-[10px] font-bold uppercase tracking-wider text-blue-800 whitespace-nowrap">ESTADO DE VERIFICACIÓN</th>
                        <th className="px-3 py-2 text-left text-[10px] font-bold uppercase tracking-wider text-blue-800 whitespace-nowrap">ESTADO DE DESPACHO</th>
                        <th className="px-3 py-2 text-left text-[10px] font-bold uppercase tracking-wider text-blue-800 whitespace-nowrap">FECHA DE REGISTRO</th>
                        <th className="px-3 py-2 text-left text-[10px] font-bold uppercase tracking-wider text-blue-800 whitespace-nowrap">OBSERVACIONES</th>
                    ...
                    <tbody className="divide-y divide-gray-100">
                      {loadingData ? (
                        ...
                        <tr key={facturacion.id} className="hover:bg-gray-50 transition-colors">
                          ...
                          <td className="px-3 py-2 whitespace-nowrap text-[10px] text-gray-700">{facturacion.numeroDespacho}</td>
                          ...
                          <td className="px-3 py-2 whitespace-nowrap">
                            {facturacion.estadoDespacho && (
                              <span className="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-semibold border bg-green-500/20 backdrop-blur-sm border-green-500/40 text-green-800">
                                {facturacion.estadoDespacho}
                              </span>
                            )}
                          </td>
                          ...
                          <td className="px-3 py-2 whitespace-nowrap">
                            <button className="flex items-center justify-center w-8 h-8 bg-gray-500/20 backdrop-blur-sm border border-gray-500/40 hover:bg-gray-500/30 hover:border-gray-600/60 text-gray-800 rounded-full text-[10px] font-semibold transition-all duration-200 shadow-sm hover:shadow-md active:scale-[0.95]">
                              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
