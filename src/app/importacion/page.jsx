          ...
          <div className="max-w-[95%] mx-auto px-4 py-4">
            ...
            <div className="mb-6">
              <div className="flex items-center space-x-3 mb-2">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-gray-900 tracking-tight">IMPORTACIÓN</h1>
                  <p className="text-sm text-gray-600 font-medium mt-0.5">Gestión de Importaciones y Despachos</p>
                </div>
              </div>
            </div>
                      ...
                      <div className="p-4 bg-slate-200">
                        <div className={`grid gap-3 ${section.cards.length === 1 ? "grid-cols-1" : section.cards.length <= 3 ? "grid-cols-1 md:grid-cols-2 lg:grid-cols-3" : "grid-cols-1 md:grid-cols-2 lg:grid-cols-3"}`}>
                          {section.cards.map((card) => (
                            <div
                              key={card.id}
                              className="bg-[#FFFFFF] rounded-[14px] p-4 border-2 border-gray-300 hover:border-[#155EEF] transition-all duration-200"
                            ...
                            >
                              ...
                              <button
                                ...
                                className="w-full flex items-center justify-center space-x-1.5 px-3 py-2 bg-gradient-to-br from-[#155EEF] to-[#1D4ED8] text-white rounded-lg font-semibold transition-all duration-200 shadow-sm hover:shadow-md hover:scale-105 active:scale-[0.98] text-sm group"
                              >
                                {card.buttonIcon}
