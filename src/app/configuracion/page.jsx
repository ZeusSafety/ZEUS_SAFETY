              ...
              <div className="space-y-3">
                {sections.map((section) => (
                  <div key={section.id} className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
                    {/* Header de Sección */}
                    <div className="px-4 py-3 bg-blue-700/20 backdrop-blur-md border-b border-blue-300/30">
                      <div className="flex items-center space-x-2">
                        <div className="w-8 h-8 bg-blue-700/15 backdrop-blur-sm rounded-lg flex items-center justify-center text-blue-800 border-2 border-blue-600/30 shadow-sm">
                          {section.icon}
                        </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        {section.options.map((option) => (
                          <button
                            ...
                            className="bg-white/80 backdrop-blur-sm rounded-lg border border-gray-200/60 p-3 hover:border-blue-700/60 hover:shadow-xl hover:bg-white/95 transition-all duration-200 shadow-sm text-left group"
                          >
