 ...
 export default function HistorialCotizacionesPage() {
   ...
   useEffect(() => {
     ...
     setFilteredCotizaciones(lista);
     setCurrentPage(1);
   }, [cotizaciones, searchNombre, fechaInicio, fechaFin]);
   ...
   const renderEstadoBadge = (estado) => {
     ...
     const esAceptado = texto.toLowerCase() === "aceptado";
     const baseClasses =
       "inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-semibold border-2";
     const colores = esAceptado
       ? "bg-green-600 border-green-700 text-white"
       : "bg-yellow-200 border-yellow-500 text-gray-900";
     return <span className={`${baseClasses} ${colores}`}>{texto}</span>;
   };
                   ...
                   <div>
                     ...
                     <div className="flex gap-2">
                       ...
                       <button
                         ...
                         className="px-3 py-2 bg-gradient-to-br from-gray-400 to-gray-500 text-white rounded-lg text-[10px] sm:text-xs font-semibold hover:opacity-90 transition-all duration-200 shadow-sm hover:shadow-md active:scale-[0.95] whitespace-nowrap"
                       >
                         Limpiar
                       </button>
                     </div>
                             ...
                             <td className="px-3 py-2 whitespace-nowrap text-center">
                               {item.RUTA_PDF ? (
                                 ...
                                 <button
                                   type="button"
                                   disabled
                                   className="inline-flex items-center space-x-1 px-2.5 py-1 bg-gradient-to-br from-gray-400 to-gray-500 text-white rounded-lg text-[10px] font-semibold opacity-60 cursor-not-allowed select-none"
                                 >
                                   <svg
                                     className="w-3 h-3"
                                     fill="none"
                                   ...
                                   <span style={{ pointerEvents: 'none' }}>Sin PDF</span>
                                 </button>
                               )}
                             </td>
                             <td className="px-3 py-2 whitespace-nowrap text-center">
