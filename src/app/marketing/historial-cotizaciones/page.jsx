                   ...
                   <div>
                     ...
                     <div className="flex gap-2">
                       ...
                       <button
                         ...
                         className="px-3 py-2 bg-gray-100 border border-gray-300 rounded-lg text-[10px] sm:text-xs font-semibold text-gray-700 hover:bg-gray-200 transition-colors whitespace-nowrap"
                       >
                         Limpiar
                       </button>
                     </div>
