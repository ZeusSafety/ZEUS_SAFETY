...
import { getZeusSafetyReport } from "../../../services/marketingReportApi";
...
export default function ZeusSafetyPage() {
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1" style={{ fontFamily: "var(--font-poppins)" }}>
                      Analítica específica de Zeus Safety: Ventas, canales y regiones
                    </p>
                  </div>
                </div>
                            ...
                            <tbody className="divide-y divide-gray-100">
                              {clientesPaginados.map((c, idx) => {
                                ...
                                return (
                                  <tr
                                    key={`${c.name}-${idx}`}
                                    className={`transition-all cursor-pointer ${isSelected ? "bg-blue-50 border-l-4 border-l-[#3B82F6]" : "hover:bg-slate-100"} ${filters.cliente && !isSelected ? "opacity-50" : ""}`}
                                    onClick={() => {
                                      setFilters((prev) => ({
                                        ...prev,
                    ...
                    {loading ? <Skeleton className="h-64 w-full" /> : canales.length === 0 ? (
                      ...
                      <ResponsiveContainer width="100%" height="100%">
                        ...
                        >
                          ...
                          >
                            {canales.map((c, idx) => {
                              const colors = ["#60A5FA", "#3B82F6", "#2563EB", "#10B981", "#8B5CF6"];
