            ...
            <div className="bg-white rounded-3xl shadow-xl border border-gray-200/60 p-8 mb-6">
              ...
              <div className="bg-white rounded-2xl shadow-lg border border-gray-200/60 overflow-hidden">
                ...
                <div className="bg-gray-50 px-6 py-4 flex items-center justify-between border-t border-gray-200">
                  <button className="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors">
                    &lt; Anterior
                  </button>
                  <span className="text-sm text-gray-700 font-medium">
                    Página 1 de 3 (15 registros)
                  </span>
                  <button className="px-4 py-2 text-sm font-medium bg-blue-700/20 backdrop-blur-sm border border-blue-700/40 hover:bg-blue-700/30 hover:border-blue-600/60 text-blue-800 rounded-lg transition-all duration-200 shadow-sm">
                    Siguiente &gt;
                  </button>
                </div>
              </div>
            ...
            <div className="bg-white rounded-3xl shadow-xl border border-gray-200/60 p-8 mb-6">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-gray-900">Registro Diario de Entrada y Salida</h2>
                    <p className="text-sm text-gray-600 mt-1">Control de asistencia del día</p>
                  </div>
                </div>
                <div className="flex items-center space-x-2 bg-green-50 border border-green-200 rounded-lg px-3 py-1.5">
                  <svg className="w-4 h-4 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2.5}>
                ...
                <div className="overflow-x-auto">
                  <table className="w-full">
                    <thead>
                      <tr className="bg-blue-700/20 backdrop-blur-md border-b border-blue-700/40">
                        <th className="px-6 py-4 text-left text-sm font-bold uppercase tracking-wider text-blue-800">NOMBRE</th>
                        <th className="px-6 py-4 text-left text-sm font-bold uppercase tracking-wider text-blue-800">FECHA</th>
                        <th className="px-6 py-4 text-left text-sm font-bold uppercase tracking-wider text-blue-800">ENTRADA</th>
                        <th className="px-6 py-4 text-left text-sm font-bold uppercase tracking-wider text-blue-800">SALIDA</th>
                        <th className="px-6 py-4 text-left text-sm font-bold uppercase tracking-wider text-blue-800">ESTADO</th>
                        <th className="px-6 py-4 text-center text-sm font-bold uppercase tracking-wider text-blue-800">ACCIÓN</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-gray-100">
                      {registrosAsistencia.map((registro) => (
                        <tr key={registro.id} className="hover:bg-gray-50 transition-colors">
                          <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{registro.nombre}</td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{registro.fecha}</td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{registro.entrada}</td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{registro.salida}</td>
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-center">
                            <button className="flex items-center space-x-1.5 px-3 py-1.5 bg-blue-700/20 backdrop-blur-sm border border-blue-700/40 hover:bg-blue-700/30 hover:border-blue-600/60 text-blue-800 rounded-lg text-xs font-semibold transition-all duration-200 shadow-sm hover:shadow-md active:scale-[0.95] mx-auto">
                              <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
            ...
            <div className="bg-white rounded-3xl shadow-xl border border-gray-200/60 p-8">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-gray-900">Formularios de Incidencias</h2>
                    <p className="text-sm text-gray-600 mt-1">Faltas, tardanzas y justificaciones</p>
                  </div>
                </div>
                <button className="flex items-center space-x-2 px-5 py-2.5 bg-blue-700/20 backdrop-blur-md border border-blue-700/40 hover:bg-blue-700/30 hover:border-blue-600/60 text-blue-800 rounded-xl font-semibold transition-all duration-200 shadow-md hover:shadow-lg active:scale-[0.98]">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2.5}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M12 4v16m8-8H4" />
                  </svg>
                ...
                <div className="overflow-x-auto">
                  <table className="w-full">
                    <thead>
                      <tr className="bg-blue-700/20 backdrop-blur-md border-b border-blue-700/40">
                        <th className="px-6 py-4 text-left text-sm font-bold uppercase tracking-wider text-blue-800">NOMBRE</th>
                        <th className="px-6 py-4 text-left text-sm font-bold uppercase tracking-wider text-blue-800">TIPO</th>
                        <th className="px-6 py-4 text-left text-sm font-bold uppercase tracking-wider text-blue-800">FECHA</th>
                        <th className="px-6 py-4 text-left text-sm font-bold uppercase tracking-wider text-blue-800">JUSTIFICACIÓN</th>
                        <th className="px-6 py-4 text-left text-sm font-bold uppercase tracking-wider text-blue-800">ESTADO</th>
                        <th className="px-6 py-4 text-center text-sm font-bold uppercase tracking-wider text-blue-800">ACCIÓN</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-gray-100">
                      {incidenciasAsistencia.map((incidencia) => (
                        <tr key={incidencia.id} className="hover:bg-gray-50 transition-colors">
                          <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{incidencia.nombre}</td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{incidencia.tipo}</td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{incidencia.fecha}</td>
                          <td className="px-6 py-4 text-sm text-gray-700">{incidencia.justificacion}</td>
                          <td className="px-6 py-4 whitespace-nowrap">
                            <span className={`px-3 py-1 rounded-full text-xs font-semibold ${
          ...
          <div className="bg-white rounded-3xl shadow-xl border border-gray-200/60 p-8">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-gray-900">Solicitudes de Permisos</h2>
                  <p className="text-sm text-gray-600 mt-1">Gestión de permisos médicos, personales y otras actividades</p>
                </div>
              </div>
                ...
                <table className="w-full">
                  <thead>
                    <tr className="bg-blue-700/20 backdrop-blur-md border-b border-blue-700/40">
                      ...
                      <th className="px-6 py-4 text-left text-sm font-bold uppercase tracking-wider text-blue-800">TIPO</th>
                      <th className="px-6 py-4 text-left text-sm font-bold uppercase tracking-wider text-blue-800">FECHA</th>
                      <th className="px-6 py-4 text-left text-sm font-bold uppercase tracking-wider text-blue-800">DÍAS</th>
                      <th className="px-6 py-4 text-left text-sm font-bold uppercase tracking-wider text-blue-800">MOTIVO</th>
                      <th className="px-6 py-4 text-left text-sm font-bold uppercase tracking-wider text-blue-800">JEFE</th>
                      <th className="px-6 py-4 text-left text-sm font-bold uppercase tracking-wider text-blue-800">ESTADO</th>
                      <th className="px-6 py-4 text-center text-sm font-bold uppercase tracking-wider text-blue-800">ACCIÓN</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-gray-100">
                    {solicitudesPermisos.map((solicitud) => (
                      <tr key={solicitud.id} className="hover:bg-gray-50 transition-colors">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{solicitud.tipo}</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{solicitud.fecha}</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{solicitud.dias}</td>
                        <td className="px-6 py-4 text-sm text-gray-700">{solicitud.motivo}</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{solicitud.jefe}</td>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span className={`px-3 py-1 rounded-full text-xs font-semibold ${
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-center">
                          <div className="flex items-center justify-center space-x-2">
                            ...
                            <button className="flex items-center space-x-1.5 px-3 py-1.5 bg-red-600/20 backdrop-blur-sm border border-red-600/40 hover:bg-red-600/30 hover:border-red-700/60 text-red-700 rounded-lg text-xs font-semibold transition-all duration-200 shadow-sm hover:shadow-md active:scale-[0.95]">
                              <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
                                <path strokeLinecap="round" strokeLinejoin="round" d="M6 18L18 6M6 6l12 12" />
                              </svg>
                              <span>Rechazar</span>
          ...
          <div className="bg-white rounded-3xl shadow-xl border border-gray-200/60 p-8">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-gray-900">Solicitudes de Vacaciones</h2>
                  <p className="text-sm text-gray-600 mt-1">Calendario de vacaciones y solicitudes pendientes</p>
                </div>
              </div>
              <div className="flex items-center space-x-2">
                <button className="flex items-center space-x-2 px-5 py-2.5 bg-blue-700/20 backdrop-blur-md border border-blue-700/40 hover:bg-blue-700/30 hover:border-blue-600/60 text-blue-800 rounded-xl font-semibold transition-all duration-200 shadow-md hover:shadow-lg active:scale-[0.98]">
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead>
                    <tr className="bg-blue-700/20 backdrop-blur-md border-b border-blue-700/40">
                      <th className="px-6 py-4 text-left text-sm font-bold uppercase tracking-wider text-blue-800">NOMBRE</th>
                      <th className="px-6 py-4 text-left text-sm font-bold uppercase tracking-wider text-blue-800">DÍAS ACUMULADOS</th>
                      <th className="px-6 py-4 text-left text-sm font-bold uppercase tracking-wider text-blue-800">DÍAS SOLICITADOS</th>
                      <th className="px-6 py-4 text-left text-sm font-bold uppercase tracking-wider text-blue-800">FECHA INICIO</th>
                      <th className="px-6 py-4 text-left text-sm font-bold uppercase tracking-wider text-blue-800">FECHA FIN</th>
                      <th className="px-6 py-4 text-left text-sm font-bold uppercase tracking-wider text-blue-800">ESTADO</th>
                      <th className="px-6 py-4 text-center text-sm font-bold uppercase tracking-wider text-blue-800">ACCIÓN</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-gray-100">
                    {solicitudesVacaciones.map((solicitud) => (
                      <tr key={solicitud.id} className="hover:bg-gray-50 transition-colors">
                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{solicitud.nombre}</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{solicitud.diasAcumulados} días</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{solicitud.diasSolicitados} días</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{solicitud.fechaInicio}</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{solicitud.fechaFin}</td>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span className={`px-3 py-1 rounded-full text-xs font-semibold ${
                            solicitud.estado === "Aprobada" ? "bg-green-100 text-green-800" :
                            "bg-yellow-100 text-yellow-800"
          ...
          <div className="bg-white rounded-3xl shadow-xl border border-gray-200/60 p-8">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-gray-900">Control de Documentos Laborales</h2>
                  <p className="text-sm text-gray-600 mt-1">Alertas de vencimiento y repositorio de documentos</p>
                </div>
              </div>
              <div className="flex items-center space-x-2 bg-green-50 border border-green-200 rounded-lg px-3 py-1.5">
                <svg className="w-4 h-4 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2.5}>
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead>
                    <tr className="bg-blue-700/20 backdrop-blur-md border-b border-blue-700/40">
                      <th className="px-6 py-4 text-left text-sm font-bold uppercase tracking-wider text-blue-800">NOMBRE</th>
                      <th className="px-6 py-4 text-left text-sm font-bold uppercase tracking-wider text-blue-800">TIPO DOCUMENTO</th>
                      <th className="px-6 py-4 text-left text-sm font-bold uppercase tracking-wider text-blue-800">FECHA VENCIMIENTO</th>
                      <th className="px-6 py-4 text-left text-sm font-bold uppercase tracking-wider text-blue-800">DÍAS RESTANTES</th>
                      <th className="px-6 py-4 text-left text-sm font-bold uppercase tracking-wider text-blue-800">ESTADO</th>
                      <th className="px-6 py-4 text-center text-sm font-bold uppercase tracking-wider text-blue-800">ACCIÓN</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-gray-100">
                    {documentosLaborales.map((documento) => (
                      <tr key={documento.id} className={`hover:bg-gray-50 transition-colors ${documento.alerta ? "bg-red-50/30" : ""}`}>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{documento.tipo}</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{documento.fechaVencimiento}</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{documento.diasRestantes} días</td>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span className={`px-3 py-1 rounded-full text-xs font-semibold ${
          ...
          <div className="bg-white rounded-3xl shadow-xl border border-gray-200/60 p-8">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-gray-900">Gestión de Remuneraciones</h2>
                  <p className="text-sm text-gray-600 mt-1">Registro de sueldos, bonos, CTS y gratificaciones</p>
                </div>
              </div>
              <div className="flex items-center space-x-2">
                <button className="flex items-center space-x-2 px-5 py-2.5 bg-green-600/20 backdrop-blur-md border border-green-600/40 hover:bg-green-600/30 hover:border-green-700/60 text-green-700 rounded-xl font-semibold transition-all duration-200 shadow-md hover:shadow-lg active:scale-[0.98]">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2.5}>
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead>
                    <tr className="bg-blue-700/20 backdrop-blur-md border-b border-blue-700/40">
                      <th className="px-6 py-4 text-left text-sm font-bold uppercase tracking-wider text-blue-800">NOMBRE</th>
                      <th className="px-6 py-4 text-left text-sm font-bold uppercase tracking-wider text-blue-800">MES</th>
                      <th className="px-6 py-4 text-left text-sm font-bold uppercase tracking-wider text-blue-800">SUELDO BASE</th>
                      <th className="px-6 py-4 text-left text-sm font-bold uppercase tracking-wider text-blue-800">BONOS</th>
                      <th className="px-6 py-4 text-left text-sm font-bold uppercase tracking-wider text-blue-800">CTS PROYECTADO</th>
                      <th className="px-6 py-4 text-left text-sm font-bold uppercase tracking-wider text-blue-800">GRATIFICACIONES</th>
                      <th className="px-6 py-4 text-left text-sm font-bold uppercase tracking-wider text-blue-800">TOTAL</th>
                      <th className="px-6 py-4 text-center text-sm font-bold uppercase tracking-wider text-blue-800">ACCIÓN</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-gray-100">
                    {remuneraciones.map((remuneracion) => (
                      <tr key={remuneracion.id} className="hover:bg-gray-50 transition-colors">
                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{remuneracion.nombre}</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{remuneracion.mes}</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">S/ {remuneracion.sueldoBase.toLocaleString()}</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">S/ {remuneracion.bonos.toLocaleString()}</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">S/ {remuneracion.ctsProyectado.toLocaleString()}</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">S/ {remuneracion.gratificaciones.toLocaleString()}</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm font-bold text-blue-800">S/ {remuneracion.total.toLocaleString()}</td>
                        <td className="px-6 py-4 whitespace-nowrap text-center">
                          <button className="flex items-center space-x-1.5 px-3 py-1.5 bg-blue-700/20 backdrop-blur-sm border border-blue-700/40 hover:bg-blue-700/30 hover:border-blue-600/60 text-blue-800 rounded-lg text-xs font-semibold transition-all duration-200 shadow-sm hover:shadow-md active:scale-[0.95] mx-auto">
                            <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
                              <path strokeLinecap="round" strokeLinejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
          ...
          <div className="bg-white rounded-3xl shadow-xl border border-gray-200/60 p-8">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-gray-900">Portal del Colaborador</h2>
                  <p className="text-sm text-gray-600 mt-1">Auto-servicio para colaboradores</p>
                </div>
              </div>
              <div className="flex items-center space-x-2 bg-green-50 border border-green-200 rounded-lg px-3 py-1.5">
                <svg className="w-4 h-4 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2.5}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-gradient-to-br from-blue-50 to-white rounded-2xl p-6 border border-blue-200/60 shadow-md hover:shadow-lg transition-all">
                <div className="w-12 h-12 bg-blue-700/20 backdrop-blur-sm rounded-xl flex items-center justify-center text-blue-800 border-2 border-blue-600/40 shadow-sm mb-4">
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                  </svg>
                </div>
                <h3 className="text-lg font-bold text-gray-900 mb-2">Ver Datos Personales</h3>
                <p className="text-sm text-gray-600 mb-4">Consulta y actualiza tu información personal</p>
                <button className="w-full px-4 py-2 bg-blue-700/20 backdrop-blur-sm border border-blue-700/40 hover:bg-blue-700/30 hover:border-blue-600/60 text-blue-800 rounded-lg font-semibold transition-all duration-200 shadow-sm hover:shadow-md">
                  Acceder
                </button>
              </div>
              ...
              <div className="bg-gradient-to-br from-blue-50 to-white rounded-2xl p-6 border border-blue-200/60 shadow-md hover:shadow-lg transition-all">
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-2">Descargar Boletas</h3>
                <p className="text-sm text-gray-600 mb-4">Descarga tus boletas de pago históricas</p>
                <button className="w-full px-4 py-2 bg-blue-700/20 backdrop-blur-sm border border-blue-700/40 hover:bg-blue-700/30 hover:border-blue-600/60 text-blue-800 rounded-lg font-semibold transition-all duration-200 shadow-sm hover:shadow-md">
                  Acceder
                </button>
              </div>
              ...
              <div className="bg-gradient-to-br from-blue-50 to-white rounded-2xl p-6 border border-blue-200/60 shadow-md hover:shadow-lg transition-all">
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-2">Ver Vacaciones Acumuladas</h3>
                <p className="text-sm text-gray-600 mb-4">Consulta tus días de vacaciones disponibles</p>
                <button className="w-full px-4 py-2 bg-blue-700/20 backdrop-blur-sm border border-blue-700/40 hover:bg-blue-700/30 hover:border-blue-600/60 text-blue-800 rounded-lg font-semibold transition-all duration-200 shadow-sm hover:shadow-md">
                  Acceder
                </button>
              </div>
              ...
              <div className="bg-gradient-to-br from-blue-50 to-white rounded-2xl p-6 border border-blue-200/60 shadow-md hover:shadow-lg transition-all">
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-2">Solicitar Permisos</h3>
                <p className="text-sm text-gray-600 mb-4">Envía solicitudes de permisos médicos o personales</p>
                <button className="w-full px-4 py-2 bg-blue-700/20 backdrop-blur-sm border border-blue-700/40 hover:bg-blue-700/30 hover:border-blue-600/60 text-blue-800 rounded-lg font-semibold transition-all duration-200 shadow-sm hover:shadow-md">
                  Acceder
                </button>
              </div>
              ...
              <div className="bg-gradient-to-br from-blue-50 to-white rounded-2xl p-6 border border-blue-200/60 shadow-md hover:shadow-lg transition-all">
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-2">Solicitar Vacaciones</h3>
                <p className="text-sm text-gray-600 mb-4">Solicita tus días de vacaciones</p>
                <button className="w-full px-4 py-2 bg-blue-700/20 backdrop-blur-sm border border-blue-700/40 hover:bg-blue-700/30 hover:border-blue-600/60 text-blue-800 rounded-lg font-semibold transition-all duration-200 shadow-sm hover:shadow-md">
                  Acceder
                </button>
              </div>
        ...
        return (
          <div className="bg-white rounded-3xl shadow-xl border border-gray-200/60 p-8">
            <div className="text-center py-12">
              <div className="w-16 h-16 bg-blue-700/20 backdrop-blur-md border-2 border-blue-600/40 rounded-2xl flex items-center justify-center text-blue-800 shadow-sm mx-auto mb-4">
          ...
          <div className="max-w-[95%] mx-auto px-6 py-6">
            ...
            <div className="bg-white rounded-3xl shadow-xl border border-gray-200/60 p-8 mb-6">
              <div className="flex items-center space-x-4 mb-6">
                ...
                <div>
                  <h1 className="text-4xl font-bold text-gray-900 tracking-tight">RECURSOS HUMANOS</h1>
                  <p className="text-lg text-gray-600 font-medium mt-1">Gestión de personal y nómina</p>
                </div>
              </div>
