                      ...
                      return (
                        <div key={index} className="flex items-center justify-between p-3 bg-white rounded-lg border border-gray-200 hover:shadow-md transition-shadow cursor-pointer" onClick={() => handleCargarHistorial(registro.id_registro)}>
                          ...
                          <div className="flex items-center space-x-1 ml-2">
                            ...
                            >
                              <svg className="w-5 h-5 text-yellow-700" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
            ...
            <div className="space-y-4 max-h-[calc(100vh-300px)] overflow-y-auto">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-900 placeholder-gray-400 disabled:bg-gray-100"
                  style={{ fontFamily: "var(--font-poppins)" }}
                  placeholder="Ej: Febrero 2026"
                  disabled={updateLoading}
                />
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-900 bg-white disabled:bg-gray-100"
                  style={{ fontFamily: "var(--font-poppins)" }}
                  disabled={updateLoading}
                >
                  <option value="">Seleccione un área</option>
