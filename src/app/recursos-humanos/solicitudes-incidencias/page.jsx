...
export default function SolicitudesIncidenciasPage() {
  ...
  const cargarSolicitudes = async () => {
    try {
      ...
      const response = await fetch(`${API_URL}?listado=rrhh`, {
        method: 'GET',
        headers: {
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  <div className="flex items-center mt-6">
                    <label className="flex items-center space-x-3 cursor-pointer group">
                      ...
                      <span className="text-sm font-semibold text-gray-800 group-hover:text-[#002D5A] transition-colors duration-200">
                        Mostrar Incidencias
                      </span>
                    </label>
                  </div>
