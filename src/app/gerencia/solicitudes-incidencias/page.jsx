...
export default function SolicitudesIncidenciasGerenciaPage() {
  ...
  const handleExportarPDF = async () => {
    try {
      ...
      // Guardar PDF
      doc.save("Reporte_Solicitudes_GERENCIA.pdf");
    } catch (error) {
        ...
        <div className="p-4 space-y-4">
          {solicitudSeleccionada && (() => {
            ...
            return reprogramaciones.map((reprog, idx) => (
              <div key={idx} className="bg-white rounded-2xl shadow-lg border border-gray-200/60 overflow-hidden">
                <div className="px-4 py-3 border-b border-gray-200/60 bg-slate-50">
                  <div className="flex items-center space-x-2">
                    <div className="w-8 h-8 bg-gradient-to-br from-[#1E63F7] to-[#1E63F7] rounded-lg flex items-center justify-center text-white font-bold text-sm">
                      {idx + 1}
                    </div>
                ...
                <div className="p-4 space-y-3">
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 mt-0.5 flex-shrink-0 bg-blue-50 rounded-lg flex items-center justify-center">
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 mt-0.5 flex-shrink-0 bg-blue-50 rounded-lg flex items-center justify-center">
                      <svg className="w-4 h-4 text-[#1E63F7]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2.5}>
                        ...
                        <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 17.25v1.5a3 3 0 01-3 3h-3a3 3 0 01-3-3v-1.5m9 0H9m9 0v-1.5a3 3 0 00-3-3h-3a3 3 0 00-3 3v1.5" />
                      </svg>
                    </div>
                    <div className="flex-1">
                      ...
                      {reprog.INFORME_REPROG || reprog.INFORME || reprog.informe ? (
                        <button
                          onClick={() => descargarPDF(reprog.INFORME_REPROG || reprog.INFORME || reprog.informe, `informe_reprogramacion_${idx + 1}.pdf`)}
                        ...
                        <span className="inline-flex items-center gap-2 px-3 py-2 bg-gray-100 text-gray-600 rounded-lg text-xs font-medium border border-gray-300">
                          <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
