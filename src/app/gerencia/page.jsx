                          ...
                          {section.cards.map((card) => (
                            ...
                            >
                              ...
                              <button 
                                ...
                                className="w-full flex items-center justify-center space-x-1.5 px-3 py-2 bg-blue-700 border-2 border-blue-800 hover:bg-blue-800 hover:border-blue-900 text-white rounded-lg font-semibold transition-all duration-200 shadow-sm hover:shadow-md active:scale-[0.98] cursor-pointer text-sm"
                              >
                                {card.buttonIcon}
