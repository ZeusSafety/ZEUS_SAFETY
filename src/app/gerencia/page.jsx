          ...
          <div className="max-w-[95%] mx-auto px-4 py-4">
            ...
            <div className="mb-6">
              <div className="flex items-center space-x-3 mb-2">
                <div className="w-12 h-12 bg-blue-700/20 backdrop-blur-md border-2 border-blue-400/40 rounded-xl flex items-center justify-center text-blue-800 shadow-sm">
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                    <path strokeLinecap="round" strokeLinejoin="round" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" />
                    <path strokeLinecap="round" strokeLinejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
            ...
            <div className="space-y-3">
              {sections.map((section) => {
                ...
                return (
                  <div key={sectionId} className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
                    {/* Header de Sección */}
                    <button
                      onClick={handleClick}
                      type="button"
                          ...
                          {section.cards.map((card) => (
                            ...
                            >
                              <div className="flex items-start justify-between mb-3">
                                <div className="w-12 h-12 bg-blue-700/20 backdrop-blur-sm rounded-lg flex items-center justify-center text-blue-800 border border-blue-700/40 shadow-sm">
                                  {card.icon}
                                </div>
                              </div>
                              ...
                              <button 
                                ...
                                className="w-full flex items-center justify-center space-x-1.5 px-3 py-2 bg-blue-700/20 backdrop-blur-sm border border-blue-700/40 hover:bg-blue-700/30 hover:border-blue-600/60 text-blue-800 rounded-lg font-semibold transition-all duration-200 shadow-sm hover:shadow-md active:scale-[0.98] cursor-pointer text-sm"
                              >
                                {card.buttonIcon}
