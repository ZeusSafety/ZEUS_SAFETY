...
export default function ProductosPage() {
  ...
  // Datos de ejemplo
  const productos = [
    { id: 1, codigo: "PROD001", nombre: "Producto A", categoria: "Categoría 1", precio: 100.00, stock: 50, activo: true },
    { id: 2, codigo: "PROD002", nombre: "Producto B", categoria: "Categoría 2", precio: 200.00, stock: 30, activo: true },
    { id: 3, codigo: "PROD003", nombre: "Producto C", categoria: "Categoría 1", precio: 150.00, stock: 25, activo: true },
    { id: 4, codigo: "PROD004", nombre: "Producto D", categoria: "Categoría 3", precio: 300.00, stock: 40, activo: true },
    { id: 5, codigo: "PROD005", nombre: "Producto E", categoria: "Categoría 2", precio: 250.00, stock: 20, activo: true },
    { id: 6, codigo: "PROD006", nombre: "Producto F", categoria: "Categoría 1", precio: 180.00, stock: 35, activo: true },
    { id: 7, codigo: "PROD007", nombre: "Producto G", categoria: "Categoría 3", precio: 400.00, stock: 15, activo: true },
    { id: 8, codigo: "PROD008", nombre: "Producto H", categoria: "Categoría 2", precio: 220.00, stock: 28, activo: true },
    { id: 9, codigo: "PROD009", nombre: "Producto I", categoria: "Categoría 1", precio: 120.00, stock: 45, activo: true },
    { id: 10, codigo: "PROD010", nombre: "Producto J", categoria: "Categoría 3", precio: 350.00, stock: 22, activo: true },
    { id: 11, codigo: "PROD011", nombre: "Producto K", categoria: "Categoría 2", precio: 280.00, stock: 18, activo: true },
    { id: 12, codigo: "PROD012", nombre: "Producto L", categoria: "Categoría 1", precio: 160.00, stock: 32, activo: true },
    { id: 13, codigo: "PROD013", nombre: "Producto M", categoria: "Categoría 3", precio: 420.00, stock: 12, activo: true },
    { id: 14, codigo: "PROD014", nombre: "Producto N", categoria: "Categoría 2", precio: 240.00, stock: 26, activo: true },
    { id: 15, codigo: "PROD015", nombre: "Producto O", categoria: "Categoría 1", precio: 140.00, stock: 38, activo: true },
  ];

  const productosInactivos = [
    { id: 16, codigo: "PROD016", nombre: "Producto P", categoria: "Categoría 3", precio: 500.00, stock: 0, activo: false },
  ];
            ...
            <div className="bg-white rounded-2xl shadow-xl border border-gray-200/60 p-6 mb-6">
              <div>
                ...
                <button
                  ...
                  className="mb-4 flex items-center space-x-1.5 px-3 py-2 bg-gradient-to-br from-[#155EEF] to-[#1D4ED8] text-white rounded-lg font-semibold hover:shadow-md hover:scale-105 transition-all duration-200 shadow-sm active:scale-[0.98] text-sm"
                >
                    ...
                    <table className="w-full">
                      <thead>
                        <tr className="bg-blue-700 border-b-2 border-blue-800">
                          ...
                          <th className="px-3 py-2 text-left text-[10px] font-bold uppercase tracking-wider text-white whitespace-nowrap">STOCK</th>
                      ...
                      <tbody className="divide-y divide-gray-100">
                        {paginatedActivos.map((producto) => (
                          <tr key={producto.id} className="hover:bg-slate-200 transition-colors">
                            ...
                            <td className="px-3 py-2 whitespace-nowrap text-[10px] text-gray-700">${producto.precio.toFixed(2)}</td>
                            <td className="px-3 py-2 whitespace-nowrap text-[10px] text-gray-700">{producto.stock}</td>
