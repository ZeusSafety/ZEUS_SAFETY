...
export default function AsistenciasPage() {
  ...
  // Cargar automáticamente el último registro del historial al entrar
  useEffect(() => {
    if (historialCargas.length > 0 && excelData.length === 0 && !loadingData) {
  ...
  }, [historialCargas.length, loadingData]);
  ...
  // Solo usar excelData, no combinar con dashboardData
                      ...
                      historialCargas.map((registro, index) => (
                        <div key={index} className="flex items-center justify-between p-2 bg-white rounded-lg border border-gray-200">
                          ...
                          <div className="flex items-center space-x-1">
                            <button
                              onClick={() => handleCargarHistorial(registro.id_registro)}
                            ...
                            <button
                              onClick={() => handleDescargarPDF(registro.id_registro, registro.pdf_reporte)}
