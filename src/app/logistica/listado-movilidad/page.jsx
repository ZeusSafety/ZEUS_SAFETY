...
export default function ListadoMovilidadLogisticaPage() {
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                                {vehiculos.map((vehiculo) => (
                                    <button
                                        ...
                                        className={`p-6 rounded-xl border-2 transition-all duration-200 ${vehiculoSeleccionado === vehiculo.nombre
                                                    ...
                                                    <tbody className="divide-y divide-gray-100">
                                                        {registrosPaginados.map((registro, idx) => (
                                                            <tr key={idx} className="hover:bg-blue-50 transition-colors border-b border-gray-100">
                                                                ...
                                                                <td className="px-4 py-3 whitespace-nowrap text-[10px] font-medium text-gray-900" style={{ fontFamily: 'var(--font-poppins)' }}>{registro.conductor || "-"}</td>
                                                                <td className="px-4 py-3 whitespace-nowrap text-[10px] text-gray-700" style={{ fontFamily: 'var(--font-poppins)' }}>
