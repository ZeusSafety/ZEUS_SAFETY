...
export async function POST(request) {
  try {
    ...
    const apiUrl = "https://api-descuento-reservas-caja-logistica-2946605267.us-central1.run.app/descuentoStockCajasVendidas";
    ...
    console.error("Error en API descuento-cajas/descuento-stock:", error.message);
