...
export async function GET(request) {
  try {
    ...
    const apiUrl = "https://api-descuento-reservas-caja-logistica-2946605267.us-central1.run.app/historial/general";
    ...
    console.error("Error en API descuento-cajas/historial-general:", error.message);
