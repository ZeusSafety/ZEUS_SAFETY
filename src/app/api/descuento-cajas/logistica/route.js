...
export async function PUT(request) {
  try {
    ...
    const apiUrl = "https://api-descuento-reservas-caja-logistica-2946605267.us-central1.run.app/logistica";
    ...
    console.error("Error en API descuento-cajas/logistica:", error.message);
