...
export default function SolicitudesIncidenciasPage() {
  ...
  const descargarPDF = async (url, nombreArchivo = "archivo.pdf") => {
    try {
      const token = localStorage.getItem("token");
                    ...
                    <table className="w-full">
                      <thead>
                        <tr className="bg-blue-700 border-b-2 border-blue-800">
                          ...
                          <th className="px-3 py-2 text-[10px] font-bold uppercase tracking-wider text-white whitespace-nowrap text-center">Informe</th>
                            ...
                            <tr key={solicitud.ID_SOLICITUD || solicitud.id || index} className="hover:bg-slate-200 transition-colors">
                              ...
                              <td className="px-3 py-2 whitespace-nowrap text-center">
                                <button 
                                  ...
                                  className="inline-flex items-center space-x-1 px-3 py-1.5 bg-gradient-to-br from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white rounded-lg text-[10px] font-semibold transition-all duration-200 shadow-sm hover:shadow-md active:scale-[0.95] cursor-pointer select-none"
                                >
                                  <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5} style={{ pointerEvents: 'none' }}>
