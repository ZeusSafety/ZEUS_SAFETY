            ...
            <div className="mb-6">
              <div className="flex items-center space-x-3 mb-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 font-medium mt-0.5">Gestión General del Sistema</p>
                </div>
              </div>
            </div>
                        ...
                        {section.cards.map((card) => (
                          ...
                          >
                            <div className="flex items-start justify-between mb-3">
                              <div className="w-12 h-12 bg-blue-700/15 backdrop-blur-sm rounded-lg flex items-center justify-center text-blue-800 border-2 border-blue-600/30 shadow-sm">
                                {card.icon}
                              </div>
                            </div>
                            ...
                            <button className="w-full flex items-center justify-center space-x-1.5 px-3 py-2 bg-blue-700/20 backdrop-blur-sm border-2 border-blue-600/40 hover:bg-blue-700/30 hover:border-blue-700/60 text-blue-800 rounded-lg font-semibold transition-all duration-200 shadow-sm hover:shadow-md active:scale-[0.98] text-sm">
                              {card.buttonIcon}
