          ...
          <div className="max-w-[95%] mx-auto px-4 py-4">
            ...
            <div className="mb-6">
              <div className="flex items-center space-x-3 mb-2">
                ...
                <div>
                  <h1 className="text-2xl font-medium text-gray-900 tracking-tight" style={{ fontFamily: 'var(--font-poppins)' }}>ADMINISTRACIÓN</h1>
                            ...
                            <div className="relative z-10">
                              ...
                              <button
                                onClick={() => {
                                  ...
                                  } else if (card.id === "proformas-actas") {
                                    router.push("/administracion/incidencias/proformas-actas");
                                  } else if (card.id === "gestionar-productos") {
