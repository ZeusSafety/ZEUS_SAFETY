          ...
          <div className="max-w-[95%] mx-auto px-6 py-6">
            ...
            <div className="mb-8">
              <div className="flex items-center space-x-4 mb-3">
                ...
                <div>
                  <h1 className="text-4xl font-bold text-gray-900 tracking-tight">ADMINISTRACIÓN</h1>
                  <p className="text-lg text-gray-600 font-medium mt-1">Gestión General del Sistema</p>
                </div>
              </div>
            </div>
